...
var imagesTypes_1 = require("./imagesTypes");
jest.mock('fs');
...
describe('your test', function () {
    jest.spyOn(utils, 'clearnFiles').mockImplementation(function () { return ['image1.jpeg']; });
    jest
        .spyOn(utils, 'createPictureSize')
    ...
    test('your test description', function () {
        expect((0, imagesTypes_1.checkIfImagesExist)(200, 400)).toStrictEqual({
