...
describe('test image file utilities', function () {
    ...
    it('insists directory exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        var outputDir;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('resizes image file asset', function () { return __awaiter(void 0, void 0, void 0, function () {
        var inputFile, outputFile, thumbnailFile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputFile = path_1.default.join(__dirname, '../../assets/full/encenadaport.jpeg');
